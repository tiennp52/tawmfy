...
(function($) {
  ...
  $.fn.audioplayer = function(o) {
    ...
    this.each(function() {
      ...
      // console.log('o.settings_extrahtml_in_float_right - ',o.settings_extrahtml_in_float_right);
        ...
        if (type == 'youtube' && is_ios() && 1==0) {
          ...
          if (o.cue == 'on' && type != 'soundcloud') {
            ...
            if(dataSrc.indexOf('{{generatenonce}}') > -1){
              ...
              // console.log('type_normal_stream_type - ',type_normal_stream_type);
              if(type_normal_stream_type!='shoutcast' && type_normal_stream_type!='icecast'){
                setup_media();
              }else{
      ...
      function icecast_get_data(){

        $.ajax({
          type: "GET",
          url: cthis.attr('data-source'),
          crossDomain: true,
          success: function (response) {
            ...
            if(radio_update_song_name) {
              ...
              var regex_title = /<title>(.*?)<\/title>/g

              if (aux = regex_title.exec(response)) {
                _metaArtistCon.find('.the-name').html(aux[1])
              }

            }
            if(radio_update_artist_name){
              var regex_creator = /<creator>(.*?)<\/creator>/g

              if(aux = regex_creator.exec(response)){
                _metaArtistCon.find('.the-artist').html(aux[1])
              }
            }
          },
          error: function(err){
      ...
      function playlist_goto_item(arg,pargs) {
        ...
        if(_playlistTooltip){
          _playlistTooltip.find('.dzstooltip--inner');
      ...
      function setup_structure(pargs) {
        ...
        // console.log('setup_structure', margs);
        ...
        if (o.design_skin == 'skin-wave' && skinwave_mode == 'small') {
          ...
          if (o.design_skin == 'skin-aria' || o.design_skin == 'skin-silver' || o.design_skin == 'skin-redlights' || o.design_skin == 'skin-steel') {
            ...
            //console.log(o.settings_extrahtml_in_float_right);
        ...
        if(radio_update_song_name == false && _metaArtistCon.find('.the-name').length && _metaArtistCon.find('.the-name').eq(0).text().length > 0){
          ...
          if(_metaArtistCon.find('.the-name').eq(0).text().indexOf('{{update}}')>-1){
        ...
        // console.warn('radio_update_artist_and_song_name - ',radio_update_artist_and_song_name);
      ...
      function setup_media(pargs) {
        ...
        // console.log('--- setup_media()', cthis.attr('data-source'), o.cue,ajax_view_submitted, margs, loaded, cthis, o.preload_method, 'loaded - ',loaded);
...
//                            console.log(auxa);
      ...
      function handle_end(pargs) {
        ...
        console.log('handle_end', cthis, margs,   o.fakeplayer, 'action_audio_end - ',action_audio_end, 'time_total - ',time_total, cthis);
  ...
  $.fn.audiogallery = function(o) {
    ...
    this.each(function() {
      ...
      function init_player_from_gallery(_cache, pargs){
        ...
        // console.log('init_player_from_gallery',margs);
